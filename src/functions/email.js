...
export const sendComplain = async (receiver, productName, complainID, complain) => {
    emailjs.send("service_iqlj461", "complain", { receiver, productName, complainID, complain }, "user_IkjenXXTajWJir7OgDZWS");
}
