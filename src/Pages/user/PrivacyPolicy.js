...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <p>
                We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how Elixir Internet Private Limited and its affiliates (collectively “Elixir, we, our, us”) collect, use, share or otherwise process your personal information through Elixir website www.Elixir.com, its mobile application, and m-site (hereinafter referred to as the “Platform”).
            </p>
            <p>
            ...
            <p>
                If you enrol into our SuperCoins Loyalty Program, we will collect and store your personal information such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to Elixir or a third-party business partner that operates online/offline establishments or platforms where you can earn SuperCoins for purchase of goods and services, and redeem SuperCoins. We will also collect your information related to your transactions on Elixir platform and such third-party business partner platforms. When such third-party business partner collects your personal information directly from you, you will be governed by their privacy policies. Elixir shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
            </p>
            <p>
                Elixir has onboarded certain third-party business partners on the Platform who specialise in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more (Ultra-Partners). If you use the services of Ultra-Partners, you will be redirected to Ultra-Partners websites/applications and your entry to Ultra-Partners websites/applications will be based on your Elixir login credentials after seeking your permissions to share the data further. Elixir shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
            </p>
            <h6 className="topic-heading">2. Use of Demographic / Profile Data / Your Information</h6>
            <p>
            ...
            <h6 className="topic-heading">4. Sharing of personal information</h6>
            <p>
                We may share personal information with our other corporate entities and affiliates for purposes of providing products and services offered by them, such as, the deferred payment options Elixir PayLater offered by Elixir Advanz Private Limited through its lending partners. These entities and affiliates may share such information with their affiliates, business partners and other third parties for the purpose of providing you their products and services, and may market to you as a result of such sharing unless you explicitly opt-out.
            </p>
            <p>
            ...
            <p>
                We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us then please login into the Notification Preference page of Platform [https://www.Elixir.com/communication-preferences/email] to unsubscribe/opt-out.
            </p>
            <h6 className="topic-heading">
            ...
            <p className="owner-name mt-3">
                Jash Vaghasiya
            </p>
            <p className="owner-name">
                Dharmik Limbani
            </p>
            <p className="owner-name" style={{ marginBottom: "1.5rem" }}>
                Maulik Kakadiya
            </p>
            <p>
                Elixir Pharma Pvt Ltd.
            </p>
            <p>
                Elixir Pharma and Warehouse near Noida Golf Course,
            </p>
            <p>
                Sector 38,  Delhi NCR,
            </p>
            ...
            <p>
                Email:elixirpharma.officer@gmail.com
            </p>
            <p>
